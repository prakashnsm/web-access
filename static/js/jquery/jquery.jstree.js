...
(function ($) {
	...
	$.jstree.plugin("search", {
		...
		defaults : {
			ajax : false,
			search_method : "saweb_attribute_contains", //"jstree_contains", // for case insensitive - jstree_contains
		...
		_fn : {
			search : function (str, skip_async) {
				...
				console.log("search_method : " + ".jstree li" + (this.data.languages ? "." + this.get_lang() : "" ) + ":" + (s.search_method) + "(" + this.data.search.str + ")");

				if(this.data.search.result.length) { this.clear_search(); }
				this.data.search.result = this.get_container().find(".jstree li" + (this.data.languages ? "." + this.get_lang() : "" ) + ":" + (s.search_method) + "(" + this.data.search.str + ")");
